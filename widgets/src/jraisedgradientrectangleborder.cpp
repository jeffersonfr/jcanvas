...
RaisedGradientRectangleBorder::RaisedGradientRectangleBorder(std::size_t size, jcolor_t<float> color):
  RectangleBorder(size, color)
{
}

RaisedGradientRectangleBorder::~RaisedGradientRectangleBorder()
{
}

void RaisedGradientRectangleBorder::Paint(Component *cmp, Graphics *g)
{
  if (cmp == nullptr) {
    return;
  }
