 ...
 ***************************************************************************/
#ifndef J_BEVELEDRECTANGLEBORDER_H
#define J_BEVELEDRECTANGLEBORDER_H
 ...
 * \author Jeff Ferr
 */
class BeveledRectangleBorder : public RectangleBorder {
  ...
  public:
     ...
     *
     */
    BeveledRectangleBorder(std::size_t size = {1}, jcolor_t<float> color = jcolor_t {0xff808080});

    /**
     * \brief
     *
     */
    virtual ~BeveledRectangleBorder();
