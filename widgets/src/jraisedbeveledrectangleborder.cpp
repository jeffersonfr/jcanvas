...
RaisedBeveledRectangleBorder::RaisedBeveledRectangleBorder(std::size_t size, jcolor_t<float> color):
  RectangleBorder(size, color)
{
}

RaisedBeveledRectangleBorder::~RaisedBeveledRectangleBorder()
{
}

void RaisedBeveledRectangleBorder::Paint(Component *cmp, Graphics *g)
{
  if (cmp == nullptr) {
    return;
  }
